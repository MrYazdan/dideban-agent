...
2. **Edit configuration:**
   ```bash
   # Set your agent ID and Dideban Core endpoint
   vim config.yaml
   ```
...
```bash
DIDEBAN_AGENT_ID="my-server"
DIDEBAN_CORE_ENDPOINT="https://api.dideban.com/metrics"
DIDEBAN_CORE_TOKEN="your-secret-token"
DIDEBAN_MODE="production"
...
```
...
Containerized deployment will be available in future versions.
